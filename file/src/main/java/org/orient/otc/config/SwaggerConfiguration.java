...
public class SwaggerConfiguration {
	...
	public Docket baseRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				//.apis(RequestHandlerSelectors.basePackage("org.orient.otc.client.controller"))
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("文件模块").description("文件模块接口文档").termsOfServiceUrl("").version("1.0").build();
	}
