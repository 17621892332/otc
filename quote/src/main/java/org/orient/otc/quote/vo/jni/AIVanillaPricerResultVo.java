...
@Data
@ApiModel("香草so返回值")
public class AIVanillaPricerResultVo{
    @ApiModelProperty("估值")
    Double pv;
    ...
    public AIVanillaPricerResultVo(Double pv, Double delta, Double gamma, Double vegaPercentage, Double thetaPerDay, Double rhoPercentage,Double dividendRhoPercentage, String message) {
        this.pv = pv;
        this.delta = delta;
        this.gamma = gamma;
