 ...
 */
@Data
public class CommodityTradeDailyVO {
    /**
     * 交易对手方名称
     */
     ...
     * 是否中央对手方清算
     */
    private String isCentralClearingPlatform;
    /**
     * 中央清算平台名称
     */
    private String centralClearingPlatform;
    /**
     * 交易平台
     */
     ...
     * 期权产品结构
     */
    private String optionProductStructure;
     ...
     * 交易名义金额
     */
    private String nominalTransactionAmount;
     ...
     * 交易名义数量
     */
    private String nominalTransactionNumber;
     ...
     * 权利金收支或结算收益
     */
    private String royaltyIncomeExpenditure;
